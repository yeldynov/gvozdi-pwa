...
const Icons = {
  ...
  apple: ic(
    <>
      <path
        d='M16.3 8.1c-.5.6-1.3 1.1-2.2 1-.1-.9.3-1.8.8-2.3.5-.6 1.4-1.1 2.2-1.1.1.9-.3 1.8-.8 2.4zm.7 1.2c-1.2-.1-2.3.7-2.9.7-.6 0-1.5-.7-2.5-.7-1.3 0-2.5.7-3.2 1.9-1.4 2.4-.4 5.9 1 7.9.7.9 1.4 2 2.5 1.9 1 0 1.4-.6 2.6-.6s1.6.6 2.7.6c1.1 0 1.8-1 2.4-1.9.8-1.1 1.1-2.1 1.1-2.2 0 0-2.2-.8-2.2-3.3 0-2 1.6-2.9 1.7-3-1-1.4-2.4-1.5-2.9-1.5l-.3.2z'
        fill='currentColor'
      />
    </>,
  ),
  google: ic(
    <>
      <path
        d='M21.5 12.2c0-.7-.1-1.4-.2-2H12v3.8h5.3a4.6 4.6 0 0 1-2 3v2.5h3.2c1.9-1.7 3-4.3 3-7.3z'
        fill='#4285F4'
      />
      <path
        d='M12 21.5c2.7 0 5-.9 6.5-2.4l-3.2-2.5c-.9.6-2 1-3.3 1-2.5 0-4.7-1.7-5.4-4H3.3v2.5A9.5 9.5 0 0 0 12 21.5z'
        fill='#34A853'
      />
      <path
        d='M6.6 13.6a5.7 5.7 0 0 1 0-3.6V7.5H3.3a9.5 9.5 0 0 0 0 8.6l3.3-2.5z'
        fill='#FBBC05'
      />
      <path
        d='M12 6c1.5 0 2.8.5 3.8 1.5l2.8-2.8A9.5 9.5 0 0 0 3.3 7.5l3.3 2.5c.7-2.3 2.9-4 5.4-4z'
        fill='#EA4335'
      />
    </>,
  ),
