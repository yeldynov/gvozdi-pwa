  ...
  return (
    <div className='h-full flex flex-col bg-bg'>
      <div className='px-6 flex justify-between items-center pt-[52px] pb-6'>
        ...
        <button className='border-none bg-transparent text-text-2 p-0 text-[13px]'>
          Restore
        </button>
      </div>
      ...
      <div className='flex-1 overflow-auto px-6 pb-4'>
        ...
        <div className='text-text-2 mb-6 text-[14px] leading-[1.55]'>
          ...
          <strong className='text-text'>Gvozdi+</strong> opens 80+ guided
          sessions, multi-device sync, and the data export your therapist
          actually wants.
        </div>
        ...
        <div className='flex flex-col gap-4 mb-7'>
          {[
            {
              I: Icons.library,
              t: '80+ guided audio sessions',
              s: 'For the days when "just stand" isn\'t enough.',
            },
            {
              I: Icons.chart,
              t: 'Full history & data export',
              s: 'CSV, Apple Health, Oura. Your data, yours.',
            },
            {
              I: Icons.heart,
              t: 'Biometric pairing',
              s: 'HRV-aware pacing. Live heart rate during sessions.',
            },
            {
              I: Icons.leaf,
              t: 'Soundscapes & breath guides',
              s: 'Eight tracks, low-frequency, headphone-friendly.',
            },
          ].map((f, i) => {
            const I = f.I
            return (
              <div key={i} className='flex gap-[14px]'>
                ...
                <div className='flex-1'>
                  ...
                  <div className='text-text-2 text-[12px] leading-[1.5]'>
                    {f.s}
                  </div>
                </div>
              </div>
              ...
              >
                <div
                  ...
                  style={{
                    border:
                      '1.5px solid ' +
                      (on ? 'var(--p-primary)' : 'var(--p-divider)'),
                  }}
                >
                  {on && (
                    <div className='w-[10px] h-[10px] rounded-pill bg-primary' />
                  )}
                </div>
                <div className='flex-1'>
                  ...
                  <div className='text-text-2 mt-[2px] text-[12px]'>
                    {o.sub}
                  </div>
                </div>
