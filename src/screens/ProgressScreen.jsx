      ...
      <div className="px-6 pt-[52px] pb-[100px]">
        ...
        <div className="grid grid-cols-2 gap-2 mb-5">
          {[
            ...
            <div key={s.l} className="card flat" style={{ padding: 16 }}>
              <div className="text-text-3 uppercase mb-2 text-[11px] tracking-[0.1em]">{s.l}</div>
              <div className="num display text-[36px] leading-none font-light" style={{ color: s.col }}>{s.v}</div>
        ...
        <div className="card mb-[14px]" style={{ padding: 18 }}>
          <div className="flex justify-between items-baseline mb-[14px]">
            ...
            <div className="text-text-3"><Icons.more size={16} /></div>
          </div>
        ...
        <div className="card mb-[14px]" style={{ padding: 18 }}>
          <div className="flex justify-between items-baseline mb-[14px]">
            <div>
              ...
              <div className="text-text-3 mt-[2px] text-[11px]">Settled-rate · 7 days</div>
            </div>
            <span className="chip bg-success text-bg" style={{ padding: '4px 8px', fontSize: 11 }}>+18%</span>
          </div>
          <svg viewBox={`0 0 ${W} ${H + 24}`} width="100%" height="120" preserveAspectRatio="none" className="overflow-visible">
            <defs>
        ...
        <div className="flex flex-col gap-2">
          {[
            ...
            const I = m.I;
            return (
              <div key={i} className="card flex items-center gap-[14px]" style={{ padding: 14 }}>
                <div
