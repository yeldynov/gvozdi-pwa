      ...
      <div className="pt-[52px] pb-[100px]">
        ...
        <div className="px-6 pb-6">
          ...
          <div
            ...
            style={{ background: 'linear-gradient(160deg, var(--p-illus) 0%, var(--p-illus-2) 100%)' }}
          >
            ...
            <div className="absolute text-white left-[18px] right-[18px] bottom-[18px]">
              ...
              <div className="mt-[6px] text-[12px] opacity-[0.85]">{featured.desc}</div>
            </div>
            <button
              className="absolute flex items-center justify-center rounded-pill border-none top-4 right-4 w-10 h-10 bg-white/95 text-[#1a1815]"
            >
              <Icons.play size={16} />
            </button>
          </div>
        ...
        <div className="px-6">
          <div className="flex justify-between items-baseline mb-[10px]">
            ...
            <div className="text-text-3 text-[12px]">{filtered.length} items</div>
          </div>
          <div className="flex flex-col gap-2">
            {filtered.map((it, i) => {
              ...
              return (
                <div key={i} className="card flex items-center gap-[14px]" style={{ padding: 12 }}>
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-medium mb-[3px] text-[15px] leading-[1.2]">{it.t}</div>
