    ...
    <div className="h-full overflow-auto bg-bg">
      <div className="pt-[52px] pb-[100px]">
        ...
        <div className="px-6 pb-6 text-center">
          ...
          <div className="display mb-1 text-[22px] leading-[1.15]">Alex Petrova</div>
          <div className="text-text-2 italic text-[13px]">"Show up before motivation does."</div>
          <div className="flex justify-center gap-[6px] mt-3">
            <span className="chip">Level 3 · Practitioner</span>
            <span className="chip bg-streak text-on-primary">12 day streak</span>
          </div>
        </div>
              ...
              return (
                <div key={i} className="card" style={{ padding: 14 }}>
                  ...
                  <div className="h-1 bg-bg-3 rounded-pill overflow-hidden">
                    <div className="h-full bg-success rounded-pill" style={{ width: `${pct * 100}%` }} />
                  </div>
                </div>
              );
            })}
        ...
        <div className="px-6 pt-6 pb-2">
          <div className="flex justify-between items-baseline mb-[10px]">
            <div className="text-text-2 uppercase text-[12px] tracking-[0.1em]">Achievements</div>
            ...
            {[
              ...
              return (
                <div key={i} className="text-center">
                  ...
                  <div
                    className="text-[11px]"
                    style={{ color: a.unlocked ? 'var(--p-text-2)' : 'var(--p-text-3)' }}
                  >
                    {a.l}
                  </div>
                </div>
        ...
        {/* settings */}
        <div className="px-6 pt-6 pb-2">
          <div className="text-text-2 uppercase mb-[10px] text-[12px] tracking-[0.1em]">Settings</div>
          <div className="bg-surface rounded-md overflow-hidden border border-divider">
            {[
              ...
              return (
                ...
                >
                  <div className="text-text-2 flex"><I size={18} /></div>
        ...
        <div className="px-6 pt-5">
          <button className="btn ghost text-text-2">Sign out</button>
