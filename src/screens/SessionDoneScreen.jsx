    ...
    <div className="h-full flex flex-col bg-bg pt-[60px] px-6 pb-7 animate-completion">
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex justify-center mb-6">
          <div
            className="w-[88px] h-[88px] rounded-pill flex items-center justify-center relative border-[1.5px] border-primary"
          >
            <Icons.check size={36} />
        ...
        <div className="flex justify-around border-t border-b border-divider py-5">
          <div className="text-center">
            <div className="num display text-[32px] font-light leading-none">6:00</div>
            <div className="text-text-3 uppercase mt-[6px] text-[10px] tracking-[0.1em]">duration</div>
          </div>
          <div className="w-[1px] bg-divider" />
          <div className="text-center">
            <div className="num display text-[32px] font-light leading-none">13</div>
            <div className="text-text-3 uppercase mt-[6px] text-[10px] tracking-[0.1em]">day streak</div>
          </div>
          <div className="w-[1px] bg-divider" />
          <div className="text-center">
            <div className="num display text-[32px] font-light leading-none">↘ 4</div>
            <div className="text-text-3 uppercase mt-[6px] text-[10px] tracking-[0.1em]">resting bpm</div>
          </div>
        </div>

        {/* mood */}
        <div className="mt-7">
          <div className="text-text-2 mb-[10px] text-[13px]">How did it land?</div>
        ...
        <div className="card flat mt-[14px]" style={{ padding: 16 }}>
          <div className="text-text-3 uppercase mb-2 text-[11px] tracking-[0.1em]">One honest line</div>
      ...
      <div className="flex gap-[10px]">
        <button className="btn ghost flex-1" onClick={() => nav('home')}>Done</button>
        <button className="btn flex-1" onClick={() => nav('progress')}>See progress</button>
      </div>
    </div>
  );
}
