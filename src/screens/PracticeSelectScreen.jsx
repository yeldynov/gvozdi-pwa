...
export function PracticeSelectScreen({ nav }) {
  ...
  return (
    <div className="h-full flex flex-col bg-bg pt-14 px-6 pb-8">
      ...
      <div className="mb-6">
        <div className="display mb-2 text-[32px] leading-[1.1]">Your practice</div>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-start w-full">
                ...
                >
                  {on && <div className="text-primary flex"><Icons.check size={12} /></div>}
                </div>
              </div>
              <div>
                <div className="font-semibold mb-[2px] text-[15px]">{o.label}</div>
      ...
      <button className="btn mt-5" onClick={() => nav('home')}>Continue</button>
