      ...
      <div className="flex-1 flex flex-col gap-7">
        ...
        <div className="flex flex-col rounded-md overflow-hidden gap-px bg-divider">
          {[
            ...
            const Ir = r.I;
            return (
              <div key={i} className="bg-surface flex items-center gap-3 py-3.5 px-4">
                <div className="text-text-2 flex"><Ir size={18} /></div>
                <div className="flex-1 text-text text-[14px]">{r.l}</div>
                <div className="text-text-2 text-[13px]">{r.v}</div>
                <div className="text-text-3 flex"><Icons.chevron_right size={16} /></div>
              </div>
            );
          })}
        </div>
